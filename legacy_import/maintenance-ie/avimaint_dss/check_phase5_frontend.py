...
assert info.get("version") == api_server.FRONTEND_VERSION == "5.0.0"

launcher = (ROOT / "FINAL_12_START_DASHBOARD.bat").read_text(encoding="utf-8")
assert "FINAL_12_START_DASHBOARD.bat" not in launcher
assert "http://127.0.0.1:8780/" in launcher
assert "frontend.version -eq '5.0.0'" in launcher
assert "streamlit run app.py" in launcher, "legacy fallback was removed"
...
print("PHASE5_FRONTEND_VERSION=5.0.0")
print("PHASE4_API_VERSION_PRESERVED=1.0.1")
